...
import { DailyService, DailyServiceCategory, StudentServiceEnrollment } from '../../types/dailyServicesWallet';
import { 
  fetchDailyServices, 
  saveDailyService, 
  deleteDailyService, 
...
export const DailyServicesManager: React.FC<Props> = ({
  ...
  const handleSaveService = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (showToast) showToast('Failed to save daily service', 'error');
    }
  };
  ...
  const handleExecuteAssignment = async (e: React.FormEvent) => {
    ...
    try {
      if (assignTargetType === 'individual') {
        ...
        if (showToast) {
          showToast(`Enrolled student ${studentObj.name || 'Student'} into "${selectedServiceToAssign.name}"`, 'success');
        }
      } else {
        // Class assignment
        await enrollStudentInService({
      ...
      if (showToast) showToast('Failed to enroll student', 'error');
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Configure school daily canteen meals, bus transport, lab usage, printing, hostel board, and extra activities.
          </p>
        </div>
      ...
      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <option value="canteen">Daily Canteen & Meals</option>
            ...
            <option value="printing">Printing & Library</option>
              ...
              >
                <div>
                  ...
                  <div className="mt-3 flex items-center justify-between text-[11px] text-slate-500">
                    <span className="font-medium">Classes: <strong className="text-slate-800">{service.applicableClasses?.join(', ')}</strong></span>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full overflow-hidden shadow-2xl border border-slate-100 animate-in fade-in zoom-in duration-150">
            ...
            <form onSubmit={handleSaveService} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g., Daily Canteen Lunch, Express School Bus"
                  value={name}
              ...
              <div>
                ...
                >
                  ...
                  <option value="bus">School Bus Transport</option>
                  <option value="extra_classes">Extra Classes & STEM</option>
                  <option value="boarding">Boarding Meals / Hostel</option>
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  placeholder="Service features, menu details, or route information..."
                  value={description}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setDailyCost(val);
                      setWeeklyCost(val * 4.5);
                      setMonthlyCost(val * 18);
                    }}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-700 mb-1">Weekly Cost</label>
                  <input
                    type="number"
                    step="1"
                    value={weeklyCost}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-700 mb-1">Monthly Cost</label>
                  <input
                    type="number"
                    step="5"
                    value={monthlyCost}
