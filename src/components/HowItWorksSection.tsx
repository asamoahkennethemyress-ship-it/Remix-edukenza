      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          {HOW_IT_WORKS_STEPS.map((step, idx) => {
            const stagger = idx === 0 ? '' : idx === 1 ? 'delay-100' : idx === 2 ? 'delay-200' : 'delay-300';
            return (
              <div
                key={step.number}
                className={`scroll-reveal ${stagger} card-hover-lift relative group bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:border-[#002147]/30 flex flex-col justify-between`}
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="w-12 h-12 rounded-lg bg-[#002147] text-[#D4AF37] flex items-center justify-center font-bold shadow-md transition-transform duration-200 group-hover:scale-105">
        ...
        {/* CTA Banner */}
        <div className="scroll-reveal delay-200 mt-12 bg-[#002147] text-white border-2 border-[#D4AF37] rounded-xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl card-hover-lift">
          ...
          <button
            ...
            className="btn-interactive px-6 py-3 rounded bg-[#D4AF37] hover:bg-[#c29f2e] text-[#002147] font-black text-xs uppercase tracking-wider shadow-lg transition-colors whitespace-nowrap flex items-center gap-2 cursor-pointer"
          >
