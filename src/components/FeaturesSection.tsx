...
export const FeaturesSection: React.FC = () => {
  ...
  return (
    <section id="features" className="py-16 bg-slate-50 text-slate-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter Controls */}
        <div className="scroll-reveal delay-75 flex flex-col md:flex-row items-center justify-between gap-4 mb-8 bg-white p-3 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredFeatures.map((feature, idx) => {
            ...
            return (
              <div
                key={feature.id}
                className={`scroll-reveal ${stagger} card-hover-lift group bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:border-[#002147]/30 flex flex-col justify-between`}
              >
                ...
                <div className="pt-4 mt-2">
                  <button
                    ...
                    className="btn-interactive w-full text-center text-xs font-bold text-[#002147] hover:text-white py-2 rounded-lg bg-slate-100 hover:bg-[#002147] border border-slate-200 transition cursor-pointer uppercase tracking-wider"
                  >
        ...
        {activeFeatureModal && (
          ...
          >
            <motion.div 
              ...
              className="bg-white border-2 border-[#002147] rounded-xl max-w-lg w-full p-6 space-y-5 shadow-2xl relative"
            >
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <button
                  ...
                  className="text-slate-500 hover:text-[#002147] p-1.5 rounded bg-slate-100 font-bold cursor-pointer"
                >
                  ✕
                </button>
              </div>
