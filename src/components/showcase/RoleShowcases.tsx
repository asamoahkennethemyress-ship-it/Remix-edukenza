          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <div className="pt-2">
              <button
                ...
                className="px-6 py-2.5 bg-[#002147] hover:bg-[#003366] text-white text-xs font-bold uppercase tracking-wider rounded-lg transition inline-flex items-center gap-2 cursor-pointer"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {(content?.highlights || []).map((cap, i) => (
                <div key={i} className="bg-white/5 border border-white/10 p-3.5 rounded-xl flex items-start gap-2.5">
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-900/90 border border-slate-700 p-6 rounded-2xl shadow-2xl space-y-4">
    ...
    <section className="py-16 bg-slate-900 text-white border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {metrics.map((m, idx) => (
            <div key={idx} className="bg-slate-950 border border-slate-800 p-5 rounded-xl text-center space-y-2">
    ...
    <section className="py-16 bg-white text-slate-900 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#002147] text-white p-8 rounded-2xl shadow-xl space-y-6 border-4 border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-[#D4AF37] text-[#002147] flex items-center justify-center font-black">
